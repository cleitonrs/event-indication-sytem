...
export default function InvitePage() {
  const inviteLink = 'http://localhost:3000/invite/2312521243356623'
      ...
      <div className="flex flex-col gap-10 w-full max-w-[550px]">
        ...
        <div className="space-y-6">
          <div className="space-y-3">
            ...
            <p className="text-gray-300">Convide mais pessoas para o evento e concorra a prêmios
              exclusivos! É śo compartilhar o link abaixo e acompanhar as
              inscrições:
            </p>
          </div>
